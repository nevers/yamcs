 ...
 * 
 * 
 * Synchronisation policy: to avoid problems with stream disappearing when clients connect to them, all
...
public class YarchDatabaseInstance {
    ...
    void serializeTableDefinition(TableDefinition td) {
        ...
        try (FileOutputStream fos = new FileOutputStream(fn)) {
            ...
            YamcsServer.getCrashHandler(instanceName).handleCrash("Archive", "Cannot write table definition to "+fn+" :"+e);
